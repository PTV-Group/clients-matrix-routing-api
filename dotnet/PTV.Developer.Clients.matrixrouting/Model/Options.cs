...
namespace PTV.Developer.Clients.matrixrouting.Model
{
    ...
    public partial class Options : IEquatable<Options>, IValidatableObject
    {
        ...
        public Options(string currency = default(string), DateTimeOffset? startTime = default(DateTimeOffset?), DateTimeOffset? tollTime = default(DateTimeOffset?), int duration = 0, TrafficMode? trafficMode = default(TrafficMode?), ResultFormat? resultFormat = default(ResultFormat?))
        {
