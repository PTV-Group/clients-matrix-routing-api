...
namespace PTV.Developer.Clients.matrixrouting.Model
{
    ...
    public partial class MatrixResponse : IEquatable<MatrixResponse>, IValidatableObject
    {
        ...
        public MatrixResponse(double percentageOfDirectDistanceRelations = default(double), List<int> distances = default(List<int>), List<int> travelTimes = default(List<int>), List<double> tollCosts = default(List<double>), List<Warning> warnings = default(List<Warning>))
        {
