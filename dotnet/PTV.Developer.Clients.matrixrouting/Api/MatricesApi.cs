...
namespace PTV.Developer.Clients.matrixrouting.Api
{
    ...
    public partial class MatricesApi : IMatricesApi
    {
        ...
        {
            PTV.Developer.Clients.matrixrouting.Client.ApiResponse<MatrixResponse> localVarResponse = CalculateMatrixWithHttpInfo(locations, profile, results);
        ...
        {
            PTV.Developer.Clients.matrixrouting.Client.ApiResponse<MatrixResponse> localVarResponse = await CalculateMatrixWithHttpInfoAsync(locations, profile, results, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
