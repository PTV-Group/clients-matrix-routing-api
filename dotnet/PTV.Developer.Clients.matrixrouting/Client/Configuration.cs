...
namespace PTV.Developer.Clients.matrixrouting.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.staging.myptv.com/matrixrouting/v1";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.staging.myptv.com/matrixrouting/v1"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.staging.myptv.com/matrixrouting/v1") : this()
        {
