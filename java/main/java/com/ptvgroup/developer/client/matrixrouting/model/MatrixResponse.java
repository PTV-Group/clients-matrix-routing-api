...
public class MatrixResponse {
  ...
  **/
  ...
  @ApiModelProperty(value = "Percentage of relations in the distance matrix which has not been calculated successfully.  ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The distances of the requested matrix elements [m]. To access to the distance of the relation between the origin i and the destination j, read the k-th element defined by `k = i * N + j`, with N being the number of destinations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The travel times of the requested matrix elements [s]. To access to the travel time of the relation between the origin i and the destination j, read the k-th element defined by `k = i * N + j`, with N being the number of destinations.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(percentageOfDirectDistanceRelations, distances, travelTimes, tollCosts);
  }
