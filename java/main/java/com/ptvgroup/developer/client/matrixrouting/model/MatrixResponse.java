...
public class MatrixResponse {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The distances of the requested matrix elements [m]. Each value is expressed as unsigned integer and uses a 4-bytes little endian scheme. See [here](./concepts/results-representation) for more information. To access to the distance of the relation between the origin i and the destination j, read the k-th element defined by `k = i * N + j`, with N being the number of destinations. Please note that the distance for an A-A relation is always set to zero.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The travel time profiles of the requested matrix elements. Each profile is expressed using a encoded format which is explained [here](./concepts/results-representation).  Please note that the travel time for an A-A relation is always set to zero.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The toll costs of the requested matrix elements in the requested currency. Each value is expressed as unsigned integer and uses a 4-bytes little endian scheme. See [here](./concepts/results-representation) for more information. To access to the toll cost of the relation between the origin i and the destination j, read the k-th element defined by `k = i * N + j`, with N being the number of destinations. Please note that the travel time for an A-A relation is always set to zero.")
