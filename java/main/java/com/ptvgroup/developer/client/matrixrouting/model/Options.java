...
public class Options {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(currency), hashCodeNullable(startTime), hashCodeNullable(tollTime), duration, trafficMode, detourFactor, averageSpeed, resultFormat);
  }
