...
public class Location {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Include the air-line connection between given and matched coordinates in the relation distance and travel time. We will refer to this type of location as an _off-road location_.")
